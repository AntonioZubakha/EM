...
const Portfolio: React.FC = () => {
  ...
  const works = [
    ...
    { img: '/5298658092193091212.jpg', alt: 'Пример работы - маникюр' },
    { img: '/5298658092193091224.jpg', alt: 'Пример работы - маникюр' },
    { img: '/5298658092193091227.jpg', alt: 'Пример работы - маникюр' },
    ...
    { img: '/5427244503883969657.jpg', alt: 'Пример работы - маникюр' },
    { img: '/5429213501576052044.jpg', alt: 'Продукция CND Shellac' },
    { img: '/5429213501576052045.jpg', alt: 'Набор для ухода за ногтями' },
